...
| `seller-add-to-cart` | Displays a Buy button that adds a given seller's product to the shopping cart. It is mandatory to use `buy-button` or `add-to-cart-button` as a child block for this component|
